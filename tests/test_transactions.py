...
class TestTransactions(unittest.TestCase):
    ...
    def testBuySell(self):
        ...
        transaction.sell("2020-01-05", 0.25, "btc", 12000, "Description")
    ...
    def testExchange(self):
        ...
        transaction.exchange("2020-01-12", 0.25, "btc", 1, "eth", 1000, "Description")
    ...
    def initBuy(self, transaction):
        ...
        transaction.buy("2020-01-01", 2, "eth", 5000, "Description")
